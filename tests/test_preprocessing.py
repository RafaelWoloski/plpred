...
def test_compute_aa_composition_result_complex_homopolymer():
...
def test_generate_aa_composition_df_columns_number():
...
def test_generate_aa_composition_df_membrane_columns():
    file_path = 'data/raw/membrane.fasta'
    df_aa_composition = generate_aa_composition_df(file_path, membrane_label=1)
